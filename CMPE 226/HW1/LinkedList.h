...
protected:
	bool searchAndFindPrev(const T &val, LLNode<T>** sNode, LLNode<T>** pNode);
...
template <typename T>
bool LinkedList<T>::searchAndFindPrev(const T &val, LLNode<T>** sNode, LLNode<T>** pNode){
